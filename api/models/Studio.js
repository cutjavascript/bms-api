  ...
  getStudioCalender: function(studioId){
    return new Promise(function(resolve, reject) {
      try {
        ...
        con.query(`SELECT id as slot_id, studio_id, 8am,9am,10am,12pm,1pm,2pm,3pm,4pm,5pm,6pm,7pm,8pm,9pm,10pm,11pm,12am,1am,2am,3am,4am,5am,6am,7am, date as day FROM studio_timeslots where studio_id = ${studioId} and date >= CURDATE()`,
